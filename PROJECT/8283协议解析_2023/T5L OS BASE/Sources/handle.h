...
void JumpPage(uint16_t pageId);
		void	ParseBuffer();
	extern u16 BUff_main[2];
	extern u8 chengxu_start;
	extern u8 chengxu_stop;
	extern u8 chengxu_start_1;
	extern u8 mode_4_flag_start;
	extern u8 icon_exit[2];
	extern u8 icon_attend[2];
	extern  u16 colour_w;
	extern u8 uart4_open_buff[2];
